 ...
 * @param[in] n - número float que será convertido.
 * @param[in] res - ponteiro que indica onde serão armazenados os caracteres de conversão.
 * @param[in] afterpoint - quantidade de dígitos após a vírgula do resultado.
 */
void ftoa(float n, char* res, int afterpoint);
/*!
 * @brief Converte inteiro para string
 * @param[in] inteiro x
 * @param[out] str[] - string vazio no qual serão escritos os valores
 * @param[out] d - quantidade de dígitos após a vírgula com o que se trabalhará. 
 */
